...
const int &year() { return stopcms3.year(); }
const int &sampver() { return stopcms3.sampver(); }
...
const float &pfmet_jup() { return stopcms3.pfmet_jup(); }
const float &pfmet_phi_jup() { return stopcms3.pfmet_phi_jup(); }
const float &pfmet_jdown() { return stopcms3.pfmet_jdown(); }
const float &pfmet_phi_jdown() { return stopcms3.pfmet_phi_jdown(); }
const float &pfmet_rl() { return stopcms3.pfmet_rl(); }
const float &pfmet_phi_rl() { return stopcms3.pfmet_phi_rl(); }
const float &pfmet_rl_jup() { return stopcms3.pfmet_rl_jup(); }
const float &pfmet_phi_rl_jup() { return stopcms3.pfmet_phi_rl_jup(); }
const float &pfmet_rl_jdown() { return stopcms3.pfmet_rl_jdown(); }
const float &pfmet_phi_rl_jdown() { return stopcms3.pfmet_phi_rl_jdown(); }
const float &pfmet_uncorr() { return stopcms3.pfmet_uncorr(); }
const float &pfmet_uncorr_phi() { return stopcms3.pfmet_uncorr_phi(); }
const float &pfmet_original() { return stopcms3.pfmet_original(); }
const float &pfmet_original_phi() { return stopcms3.pfmet_original_phi(); }
...
const float &MT2_ll() { return stopcms3.MT2_ll(); }
...
const float &MT2W_jup() { return stopcms3.MT2W_jup(); }
const float &MT2W_rl_jup() { return stopcms3.MT2W_rl_jup(); }
const float &MT2_ll_jup() { return stopcms3.MT2_ll_jup(); }
const float &mindphi_met_j1_j2_jup() { return stopcms3.mindphi_met_j1_j2_jup(); }
const float &mindphi_met_j1_j2_rl_jup() { return stopcms3.mindphi_met_j1_j2_rl_jup(); }
const float &mt_met_lep_jup() { return stopcms3.mt_met_lep_jup(); }
const float &mt_met_lep_rl_jup() { return stopcms3.mt_met_lep_rl_jup(); }
const float &MT2W_jdown() { return stopcms3.MT2W_jdown(); }
const float &MT2W_rl_jdown() { return stopcms3.MT2W_rl_jdown(); }
const float &MT2_ll_jdown() { return stopcms3.MT2_ll_jdown(); }
const float &mindphi_met_j1_j2_jdown() { return stopcms3.mindphi_met_j1_j2_jdown(); }
const float &mindphi_met_j1_j2_rl_jdown() { return stopcms3.mindphi_met_j1_j2_rl_jdown(); }
const float &mt_met_lep_jdown() { return stopcms3.mt_met_lep_jdown(); }
const float &mt_met_lep_rl_jdown() { return stopcms3.mt_met_lep_rl_jdown(); }
...
const int &ngenweights() { return stopcms3.ngenweights(); }
const vector<float> &genweights() { return stopcms3.genweights(); }
const float &weight_Q2_up() { return stopcms3.weight_Q2_up(); }
const float &weight_Q2_down() { return stopcms3.weight_Q2_down(); }
const float &weight_muF_up() { return stopcms3.weight_muF_up(); }
const float &weight_muF_down() { return stopcms3.weight_muF_down(); }
const float &weight_muR_up() { return stopcms3.weight_muR_up(); }
const float &weight_muR_down() { return stopcms3.weight_muR_down(); }
const float &weight_alphas_up() { return stopcms3.weight_alphas_up(); }
const float &weight_alphas_down() { return stopcms3.weight_alphas_down(); }
...
const float &weight_analysisbtagsf() { return stopcms3.weight_analysisbtagsf(); }
const float &weight_analysisbtagsf_heavy_UP() { return stopcms3.weight_analysisbtagsf_heavy_UP(); }
const float &weight_analysisbtagsf_light_UP() { return stopcms3.weight_analysisbtagsf_light_UP(); }
const float &weight_analysisbtagsf_heavy_DN() { return stopcms3.weight_analysisbtagsf_heavy_DN(); }
const float &weight_analysisbtagsf_light_DN() { return stopcms3.weight_analysisbtagsf_light_DN(); }
const float &weight_analysisbtagsf_fastsim_UP() { return stopcms3.weight_analysisbtagsf_fastsim_UP(); }
const float &weight_analysisbtagsf_fastsim_DN() { return stopcms3.weight_analysisbtagsf_fastsim_DN(); }
const float &weight_tightbtagsf() { return stopcms3.weight_tightbtagsf(); }
const float &weight_tightbtagsf_heavy_UP() { return stopcms3.weight_tightbtagsf_heavy_UP(); }
const float &weight_tightbtagsf_light_UP() { return stopcms3.weight_tightbtagsf_light_UP(); }
const float &weight_tightbtagsf_heavy_DN() { return stopcms3.weight_tightbtagsf_heavy_DN(); }
const float &weight_tightbtagsf_light_DN() { return stopcms3.weight_tightbtagsf_light_DN(); }
const float &weight_tightbtagsf_fastsim_UP() { return stopcms3.weight_tightbtagsf_fastsim_UP(); }
const float &weight_tightbtagsf_fastsim_DN() { return stopcms3.weight_tightbtagsf_fastsim_DN(); }
const float &weight_loosebtagsf() { return stopcms3.weight_loosebtagsf(); }
const float &weight_loosebtagsf_heavy_UP() { return stopcms3.weight_loosebtagsf_heavy_UP(); }
const float &weight_loosebtagsf_light_UP() { return stopcms3.weight_loosebtagsf_light_UP(); }
const float &weight_loosebtagsf_heavy_DN() { return stopcms3.weight_loosebtagsf_heavy_DN(); }
const float &weight_loosebtagsf_light_DN() { return stopcms3.weight_loosebtagsf_light_DN(); }
const float &weight_loosebtagsf_fastsim_UP() { return stopcms3.weight_loosebtagsf_fastsim_UP(); }
const float &weight_loosebtagsf_fastsim_DN() { return stopcms3.weight_loosebtagsf_fastsim_DN(); }
...
const float &weight_L1prefire() { return stopcms3.weight_L1prefire(); }
const float &weight_L1prefire_UP() { return stopcms3.weight_L1prefire_UP(); }
const float &weight_L1prefire_DN() { return stopcms3.weight_L1prefire_DN(); }
...
const float &topnessMod_jup() { return stopcms3.topnessMod_jup(); }
const float &topnessMod_rl_jup() { return stopcms3.topnessMod_rl_jup(); }
const float &topnessMod_jdown() { return stopcms3.topnessMod_jdown(); }
const float &topnessMod_rl_jdown() { return stopcms3.topnessMod_rl_jdown(); }
const float &Mlb_closestb() { return stopcms3.Mlb_closestb(); }
const float &Mlb_lead_bdiscr() { return stopcms3.Mlb_lead_bdiscr(); }
const float &Mlb_closestb_jup() { return stopcms3.Mlb_closestb_jup(); }
const float &Mlb_lead_bdiscr_jup() { return stopcms3.Mlb_lead_bdiscr_jup(); }
const float &Mlb_closestb_jdown() { return stopcms3.Mlb_closestb_jdown(); }
const float &Mlb_lead_bdiscr_jdown() { return stopcms3.Mlb_lead_bdiscr_jdown(); }
...
const int &HLT_MET_MHT() { return stopcms3.HLT_MET_MHT(); }
const int &HLT_MET100_MHT100() { return stopcms3.HLT_MET100_MHT100(); }
const int &HLT_MET110_MHT110() { return stopcms3.HLT_MET110_MHT110(); }
const int &HLT_MET120_MHT120() { return stopcms3.HLT_MET120_MHT120(); }
const int &HLT_MET130_MHT130() { return stopcms3.HLT_MET130_MHT130(); }
const int &HLT_PFHT_unprescaled() { return stopcms3.HLT_PFHT_unprescaled(); }
const int &HLT_PFHT_prescaled() { return stopcms3.HLT_PFHT_prescaled(); }
const int &HLT_AK8Jet_unprescaled() { return stopcms3.HLT_AK8Jet_unprescaled(); }
const int &HLT_AK8Jet_prescaled() { return stopcms3.HLT_AK8Jet_prescaled(); }
const int &HLT_CaloJet500_NoJetID() { return stopcms3.HLT_CaloJet500_NoJetID(); }
...
const float &lep1_dphiMET() { return stopcms3.lep1_dphiMET(); }
const float &lep1_dphiMET_jup() { return stopcms3.lep1_dphiMET_jup(); }
const float &lep1_dphiMET_jdown() { return stopcms3.lep1_dphiMET_jdown(); }
const float &lep1_dphiMET_rl() { return stopcms3.lep1_dphiMET_rl(); }
const float &lep1_dphiMET_rl_jup() { return stopcms3.lep1_dphiMET_rl_jup(); }
const float &lep1_dphiMET_rl_jdown() { return stopcms3.lep1_dphiMET_rl_jdown(); }
const float &lep1_dphiMET_resup() { return stopcms3.lep1_dphiMET_resup(); }
const float &lep1_dphiMET_resdown() { return stopcms3.lep1_dphiMET_resdown(); }
const float &lep1_dphiMET_rl_resup() { return stopcms3.lep1_dphiMET_rl_resup(); }
const float &lep1_dphiMET_rl_resdown() { return stopcms3.lep1_dphiMET_rl_resdown(); }
const float &lep1_dphiGenMET() { return stopcms3.lep1_dphiGenMET(); }
const float &lep1_dphiGenMET_rl() { return stopcms3.lep1_dphiGenMET_rl(); }
...
const float &lep2_dphiMET() { return stopcms3.lep2_dphiMET(); }
const float &lep2_dphiMET_jup() { return stopcms3.lep2_dphiMET_jup(); }
const float &lep2_dphiMET_jdown() { return stopcms3.lep2_dphiMET_jdown(); }
const float &lep2_dphiMET_rl() { return stopcms3.lep2_dphiMET_rl(); }
const float &lep2_dphiMET_rl_jup() { return stopcms3.lep2_dphiMET_rl_jup(); }
const float &lep2_dphiMET_rl_jdown() { return stopcms3.lep2_dphiMET_rl_jdown(); }
const float &lep2_dphiMET_resup() { return stopcms3.lep2_dphiMET_resup(); }
const float &lep2_dphiMET_resdown() { return stopcms3.lep2_dphiMET_resdown(); }
const float &lep2_dphiMET_rl_resup() { return stopcms3.lep2_dphiMET_rl_resup(); }
const float &lep2_dphiMET_rl_resdown() { return stopcms3.lep2_dphiMET_rl_resdown(); }
const float &lep2_dphiGenMET() { return stopcms3.lep2_dphiGenMET(); }
const float &lep2_dphiGenMET_rl() { return stopcms3.lep2_dphiGenMET_rl(); }
...
const vector<bool> &ph_passLooseID() { return stopcms3.ph_passLooseID(); }
const vector<bool> &ph_passMediumID() { return stopcms3.ph_passMediumID(); }
const vector<bool> &ph_passTightID() { return stopcms3.ph_passTightID(); }
...
const int &nskimjets() { return stopcms3.nskimjets(); }
const int &nskimbtagmed() { return stopcms3.nskimbtagmed(); }
const int &nskimbtagloose() { return stopcms3.nskimbtagloose(); }
const int &nskimbtagtight() { return stopcms3.nskimbtagtight(); }
const int &ngoodjets() { return stopcms3.ngoodjets(); }
const int &ngoodbtags() { return stopcms3.ngoodbtags(); }
const int &nloosebtags() { return stopcms3.nloosebtags(); }
const int &ntightbtags() { return stopcms3.ntightbtags(); }
const int &nanalysisbtags() { return stopcms3.nanalysisbtags(); }
const int &nfailjets() { return stopcms3.nfailjets(); }
const float &ak4_HT() { return stopcms3.ak4_HT(); }
const float &ak4_HTeta5() { return stopcms3.ak4_HTeta5(); }
const float &ak4_MHT_pt() { return stopcms3.ak4_MHT_pt(); }
const float &ak4_MHT_phi() { return stopcms3.ak4_MHT_phi(); }
...
const vector<float> &ak4pfjets_deepCSV() { return stopcms3.ak4pfjets_deepCSV(); }
...
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &softtags_p4() { return stopcms3.softtags_p4(); }
const int &nsoftbtags() { return stopcms3.nsoftbtags(); }
const int &jup_nskimjets() { return stopcms3.jup_nskimjets(); }
const int &jup_nskimbtagmed() { return stopcms3.jup_nskimbtagmed(); }
const int &jup_nskimbtagloose() { return stopcms3.jup_nskimbtagloose(); }
const int &jup_nskimbtagtight() { return stopcms3.jup_nskimbtagtight(); }
const int &jup_ngoodjets() { return stopcms3.jup_ngoodjets(); }
const int &jup_ngoodbtags() { return stopcms3.jup_ngoodbtags(); }
const int &jup_nloosebtags() { return stopcms3.jup_nloosebtags(); }
const int &jup_ntightbtags() { return stopcms3.jup_ntightbtags(); }
const int &jup_nanalysisbtags() { return stopcms3.jup_nanalysisbtags(); }
const int &jup_nfailjets() { return stopcms3.jup_nfailjets(); }
const float &jup_ak4_HT() { return stopcms3.jup_ak4_HT(); }
const float &jup_ak4_HTeta5() { return stopcms3.jup_ak4_HTeta5(); }
const float &jup_ak4_MHT_pt() { return stopcms3.jup_ak4_MHT_pt(); }
const float &jup_ak4_MHT_phi() { return stopcms3.jup_ak4_MHT_phi(); }
const float &jup_ak4_htratiom() { return stopcms3.jup_ak4_htratiom(); }
const vector<float> &jup_dphi_ak4pfjet_met() { return stopcms3.jup_dphi_ak4pfjet_met(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4pfjets_p4() { return stopcms3.jup_ak4pfjets_p4(); }
const vector<bool> &jup_ak4pfjets_passMEDbtag() { return stopcms3.jup_ak4pfjets_passMEDbtag(); }
const vector<float> &jup_ak4pfjets_deepCSV() { return stopcms3.jup_ak4pfjets_deepCSV(); }
const vector<float> &jup_ak4pfjets_CSV() { return stopcms3.jup_ak4pfjets_CSV(); }
const vector<float> &jup_ak4pfjets_mva() { return stopcms3.jup_ak4pfjets_mva(); }
const vector<int> &jup_ak4pfjets_parton_flavor() { return stopcms3.jup_ak4pfjets_parton_flavor(); }
const vector<int> &jup_ak4pfjets_hadron_flavor() { return stopcms3.jup_ak4pfjets_hadron_flavor(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadMEDbjet_p4() { return stopcms3.jup_ak4pfjets_leadMEDbjet_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jup_ak4pfjets_leadbtag_p4() { return stopcms3.jup_ak4pfjets_leadbtag_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak4genjets_p4() { return stopcms3.jup_ak4genjets_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_softtags_p4() { return stopcms3.jup_softtags_p4(); }
const int &jup_nsoftbtags() { return stopcms3.jup_nsoftbtags(); }
const int &jdown_nskimjets() { return stopcms3.jdown_nskimjets(); }
const int &jdown_nskimbtagmed() { return stopcms3.jdown_nskimbtagmed(); }
const int &jdown_nskimbtagloose() { return stopcms3.jdown_nskimbtagloose(); }
const int &jdown_nskimbtagtight() { return stopcms3.jdown_nskimbtagtight(); }
const int &jdown_ngoodjets() { return stopcms3.jdown_ngoodjets(); }
const int &jdown_ngoodbtags() { return stopcms3.jdown_ngoodbtags(); }
const int &jdown_nloosebtags() { return stopcms3.jdown_nloosebtags(); }
const int &jdown_ntightbtags() { return stopcms3.jdown_ntightbtags(); }
const int &jdown_nanalysisbtags() { return stopcms3.jdown_nanalysisbtags(); }
const int &jdown_nfailjets() { return stopcms3.jdown_nfailjets(); }
const float &jdown_ak4_HT() { return stopcms3.jdown_ak4_HT(); }
const float &jdown_ak4_HTeta5() { return stopcms3.jdown_ak4_HTeta5(); }
const float &jdown_ak4_MHT_pt() { return stopcms3.jdown_ak4_MHT_pt(); }
const float &jdown_ak4_MHT_phi() { return stopcms3.jdown_ak4_MHT_phi(); }
const float &jdown_ak4_htratiom() { return stopcms3.jdown_ak4_htratiom(); }
const vector<float> &jdown_dphi_ak4pfjet_met() { return stopcms3.jdown_dphi_ak4pfjet_met(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4pfjets_p4() { return stopcms3.jdown_ak4pfjets_p4(); }
const vector<bool> &jdown_ak4pfjets_passMEDbtag() { return stopcms3.jdown_ak4pfjets_passMEDbtag(); }
const vector<float> &jdown_ak4pfjets_deepCSV() { return stopcms3.jdown_ak4pfjets_deepCSV(); }
const vector<float> &jdown_ak4pfjets_CSV() { return stopcms3.jdown_ak4pfjets_CSV(); }
const vector<float> &jdown_ak4pfjets_mva() { return stopcms3.jdown_ak4pfjets_mva(); }
const vector<int> &jdown_ak4pfjets_parton_flavor() { return stopcms3.jdown_ak4pfjets_parton_flavor(); }
const vector<int> &jdown_ak4pfjets_hadron_flavor() { return stopcms3.jdown_ak4pfjets_hadron_flavor(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadMEDbjet_p4() { return stopcms3.jdown_ak4pfjets_leadMEDbjet_p4(); }
const ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > &jdown_ak4pfjets_leadbtag_p4() { return stopcms3.jdown_ak4pfjets_leadbtag_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak4genjets_p4() { return stopcms3.jdown_ak4genjets_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_softtags_p4() { return stopcms3.jdown_softtags_p4(); }
const int &jdown_nsoftbtags() { return stopcms3.jdown_nsoftbtags(); }
...
const int &nGoodAK8PFJets() { return stopcms3.nGoodAK8PFJets(); }
const vector<float> &ak8pfjets_deepdisc_qcd() { return stopcms3.ak8pfjets_deepdisc_qcd(); }
const vector<float> &ak8pfjets_deepdisc_top() { return stopcms3.ak8pfjets_deepdisc_top(); }
const vector<float> &ak8pfjets_deepdisc_w() { return stopcms3.ak8pfjets_deepdisc_w(); }
const vector<float> &ak8pfjets_deepdisc_z() { return stopcms3.ak8pfjets_deepdisc_z(); }
const vector<float> &ak8pfjets_deepdisc_zbb() { return stopcms3.ak8pfjets_deepdisc_zbb(); }
const vector<float> &ak8pfjets_deepdisc_hbb() { return stopcms3.ak8pfjets_deepdisc_hbb(); }
const vector<float> &ak8pfjets_deepdisc_h4q() { return stopcms3.ak8pfjets_deepdisc_h4q(); }
const float &lead_ak8deepdisc_top() { return stopcms3.lead_ak8deepdisc_top(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_ak8pfjets_p4() { return stopcms3.jup_ak8pfjets_p4(); }
const vector<float> &jup_ak8pfjets_tau1() { return stopcms3.jup_ak8pfjets_tau1(); }
const vector<float> &jup_ak8pfjets_tau2() { return stopcms3.jup_ak8pfjets_tau2(); }
const vector<float> &jup_ak8pfjets_tau3() { return stopcms3.jup_ak8pfjets_tau3(); }
const vector<int> &jup_ak8pfjets_parton_flavor() { return stopcms3.jup_ak8pfjets_parton_flavor(); }
const int &jup_nGoodAK8PFJets() { return stopcms3.jup_nGoodAK8PFJets(); }
const vector<float> &jup_ak8pfjets_deepdisc_qcd() { return stopcms3.jup_ak8pfjets_deepdisc_qcd(); }
const vector<float> &jup_ak8pfjets_deepdisc_top() { return stopcms3.jup_ak8pfjets_deepdisc_top(); }
const vector<float> &jup_ak8pfjets_deepdisc_w() { return stopcms3.jup_ak8pfjets_deepdisc_w(); }
const vector<float> &jup_ak8pfjets_deepdisc_z() { return stopcms3.jup_ak8pfjets_deepdisc_z(); }
const vector<float> &jup_ak8pfjets_deepdisc_zbb() { return stopcms3.jup_ak8pfjets_deepdisc_zbb(); }
const vector<float> &jup_ak8pfjets_deepdisc_hbb() { return stopcms3.jup_ak8pfjets_deepdisc_hbb(); }
const vector<float> &jup_ak8pfjets_deepdisc_h4q() { return stopcms3.jup_ak8pfjets_deepdisc_h4q(); }
const float &jup_lead_ak8deepdisc_top() { return stopcms3.jup_lead_ak8deepdisc_top(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_ak8pfjets_p4() { return stopcms3.jdown_ak8pfjets_p4(); }
const vector<float> &jdown_ak8pfjets_tau1() { return stopcms3.jdown_ak8pfjets_tau1(); }
const vector<float> &jdown_ak8pfjets_tau2() { return stopcms3.jdown_ak8pfjets_tau2(); }
const vector<float> &jdown_ak8pfjets_tau3() { return stopcms3.jdown_ak8pfjets_tau3(); }
const vector<int> &jdown_ak8pfjets_parton_flavor() { return stopcms3.jdown_ak8pfjets_parton_flavor(); }
const int &jdown_nGoodAK8PFJets() { return stopcms3.jdown_nGoodAK8PFJets(); }
const vector<float> &jdown_ak8pfjets_deepdisc_qcd() { return stopcms3.jdown_ak8pfjets_deepdisc_qcd(); }
const vector<float> &jdown_ak8pfjets_deepdisc_top() { return stopcms3.jdown_ak8pfjets_deepdisc_top(); }
const vector<float> &jdown_ak8pfjets_deepdisc_w() { return stopcms3.jdown_ak8pfjets_deepdisc_w(); }
const vector<float> &jdown_ak8pfjets_deepdisc_z() { return stopcms3.jdown_ak8pfjets_deepdisc_z(); }
const vector<float> &jdown_ak8pfjets_deepdisc_zbb() { return stopcms3.jdown_ak8pfjets_deepdisc_zbb(); }
const vector<float> &jdown_ak8pfjets_deepdisc_hbb() { return stopcms3.jdown_ak8pfjets_deepdisc_hbb(); }
const vector<float> &jdown_ak8pfjets_deepdisc_h4q() { return stopcms3.jdown_ak8pfjets_deepdisc_h4q(); }
const float &jdown_lead_ak8deepdisc_top() { return stopcms3.jdown_lead_ak8deepdisc_top(); }
const vector<float> &ak4pfjets_cvsl() { return stopcms3.ak4pfjets_cvsl(); }
const vector<float> &ak4pfjets_ptD() { return stopcms3.ak4pfjets_ptD(); }
const vector<float> &ak4pfjets_axis1() { return stopcms3.ak4pfjets_axis1(); }
const vector<float> &ak4pfjets_axis2() { return stopcms3.ak4pfjets_axis2(); }
const vector<int> &ak4pfjets_mult() { return stopcms3.ak4pfjets_mult(); }
const vector<float> &ak4pfjets_deepCSVb() { return stopcms3.ak4pfjets_deepCSVb(); }
const vector<float> &ak4pfjets_deepCSVbb() { return stopcms3.ak4pfjets_deepCSVbb(); }
const vector<float> &ak4pfjets_deepCSVc() { return stopcms3.ak4pfjets_deepCSVc(); }
const vector<float> &ak4pfjets_deepCSVl() { return stopcms3.ak4pfjets_deepCSVl(); }
const vector<vector<int> > &topcands_ak4idx() { return stopcms3.topcands_ak4idx(); }
const vector<float> &topcands_disc() { return stopcms3.topcands_disc(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &topcands_p4() { return stopcms3.topcands_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &topcands_Wp4() { return stopcms3.topcands_Wp4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &tftops_p4() { return stopcms3.tftops_p4(); }
const vector<float> &tftops_disc() { return stopcms3.tftops_disc(); }
const vector<vector<float> > &tftops_subjet_pt() { return stopcms3.tftops_subjet_pt(); }
const vector<vector<float> > &tftops_subjet_eta() { return stopcms3.tftops_subjet_eta(); }
const vector<vector<float> > &tftops_subjet_phi() { return stopcms3.tftops_subjet_phi(); }
const vector<float> &jup_ak4pfjets_cvsl() { return stopcms3.jup_ak4pfjets_cvsl(); }
const vector<float> &jup_ak4pfjets_ptD() { return stopcms3.jup_ak4pfjets_ptD(); }
const vector<float> &jup_ak4pfjets_axis1() { return stopcms3.jup_ak4pfjets_axis1(); }
const vector<float> &jup_ak4pfjets_axis2() { return stopcms3.jup_ak4pfjets_axis2(); }
const vector<int> &jup_ak4pfjets_mult() { return stopcms3.jup_ak4pfjets_mult(); }
const vector<float> &jup_ak4pfjets_deepCSVb() { return stopcms3.jup_ak4pfjets_deepCSVb(); }
const vector<float> &jup_ak4pfjets_deepCSVbb() { return stopcms3.jup_ak4pfjets_deepCSVbb(); }
const vector<float> &jup_ak4pfjets_deepCSVc() { return stopcms3.jup_ak4pfjets_deepCSVc(); }
const vector<float> &jup_ak4pfjets_deepCSVl() { return stopcms3.jup_ak4pfjets_deepCSVl(); }
const vector<vector<int> > &jup_topcands_ak4idx() { return stopcms3.jup_topcands_ak4idx(); }
const vector<float> &jup_topcands_disc() { return stopcms3.jup_topcands_disc(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_topcands_p4() { return stopcms3.jup_topcands_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_topcands_Wp4() { return stopcms3.jup_topcands_Wp4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jup_tftops_p4() { return stopcms3.jup_tftops_p4(); }
const vector<float> &jup_tftops_disc() { return stopcms3.jup_tftops_disc(); }
const vector<vector<float> > &jup_tftops_subjet_pt() { return stopcms3.jup_tftops_subjet_pt(); }
const vector<vector<float> > &jup_tftops_subjet_eta() { return stopcms3.jup_tftops_subjet_eta(); }
const vector<vector<float> > &jup_tftops_subjet_phi() { return stopcms3.jup_tftops_subjet_phi(); }
const vector<float> &jdown_ak4pfjets_cvsl() { return stopcms3.jdown_ak4pfjets_cvsl(); }
const vector<float> &jdown_ak4pfjets_ptD() { return stopcms3.jdown_ak4pfjets_ptD(); }
const vector<float> &jdown_ak4pfjets_axis1() { return stopcms3.jdown_ak4pfjets_axis1(); }
const vector<float> &jdown_ak4pfjets_axis2() { return stopcms3.jdown_ak4pfjets_axis2(); }
const vector<int> &jdown_ak4pfjets_mult() { return stopcms3.jdown_ak4pfjets_mult(); }
const vector<float> &jdown_ak4pfjets_deepCSVb() { return stopcms3.jdown_ak4pfjets_deepCSVb(); }
const vector<float> &jdown_ak4pfjets_deepCSVbb() { return stopcms3.jdown_ak4pfjets_deepCSVbb(); }
const vector<float> &jdown_ak4pfjets_deepCSVc() { return stopcms3.jdown_ak4pfjets_deepCSVc(); }
const vector<float> &jdown_ak4pfjets_deepCSVl() { return stopcms3.jdown_ak4pfjets_deepCSVl(); }
const vector<vector<int> > &jdown_topcands_ak4idx() { return stopcms3.jdown_topcands_ak4idx(); }
const vector<float> &jdown_topcands_disc() { return stopcms3.jdown_topcands_disc(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_topcands_p4() { return stopcms3.jdown_topcands_p4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_topcands_Wp4() { return stopcms3.jdown_topcands_Wp4(); }
const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &jdown_tftops_p4() { return stopcms3.jdown_tftops_p4(); }
const vector<float> &jdown_tftops_disc() { return stopcms3.jdown_tftops_disc(); }
const vector<vector<float> > &jdown_tftops_subjet_pt() { return stopcms3.jdown_tftops_subjet_pt(); }
const vector<vector<float> > &jdown_tftops_subjet_eta() { return stopcms3.jdown_tftops_subjet_eta(); }
const vector<vector<float> > &jdown_tftops_subjet_phi() { return stopcms3.jdown_tftops_subjet_phi(); }
const float &pfmet_uncorr_jup() { return stopcms3.pfmet_uncorr_jup(); }
const float &pfmet_uncorr_phi_jup() { return stopcms3.pfmet_uncorr_phi_jup(); }
const float &pfmet_uncorr_jdown() { return stopcms3.pfmet_uncorr_jdown(); }
const float &pfmet_uncorr_phi_jdown() { return stopcms3.pfmet_uncorr_phi_jdown(); }
const float &pfmet_resup() { return stopcms3.pfmet_resup(); }
const float &pfmet_phi_resup() { return stopcms3.pfmet_phi_resup(); }
const float &pfmet_resdown() { return stopcms3.pfmet_resdown(); }
const float &pfmet_phi_resdown() { return stopcms3.pfmet_phi_resdown(); }
const float &pfmet_rl_resup() { return stopcms3.pfmet_rl_resup(); }
const float &pfmet_phi_rl_resup() { return stopcms3.pfmet_phi_rl_resup(); }
const float &pfmet_rl_resdown() { return stopcms3.pfmet_rl_resdown(); }
const float &mt_met_lep_resup() { return stopcms3.mt_met_lep_resup(); }
const float &mt_met_lep_rl_resup() { return stopcms3.mt_met_lep_rl_resup(); }
const float &mt_met_lep_resdown() { return stopcms3.mt_met_lep_resdown(); }
const float &mt_met_lep_rl_resdown() { return stopcms3.mt_met_lep_rl_resdown(); }
const float &topnessMod_resup() { return stopcms3.topnessMod_resup(); }
const float &topnessMod_rl_resup() { return stopcms3.topnessMod_rl_resup(); }
const float &topnessMod_resdown() { return stopcms3.topnessMod_resdown(); }
const float &topnessMod_rl_resdown() { return stopcms3.topnessMod_rl_resdown(); }
const float &mindphi_met_j1_j2_resup() { return stopcms3.mindphi_met_j1_j2_resup(); }
const float &mindphi_met_j1_j2_rl_resup() { return stopcms3.mindphi_met_j1_j2_rl_resup(); }
const float &mindphi_met_j1_j2_resdown() { return stopcms3.mindphi_met_j1_j2_resdown(); }
const float &mindphi_met_j1_j2_rl_resdown() { return stopcms3.mindphi_met_j1_j2_rl_resdown(); }
const float &MT2_ll_resup() { return stopcms3.MT2_ll_resup(); }
const float &MT2_ll_resdown() { return stopcms3.MT2_ll_resdown(); }
const float &genmet_rl() { return stopcms3.genmet_rl(); }
const float &genmet_phi_rl() { return stopcms3.genmet_phi_rl(); }
const float &topnessMod_genmet() { return stopcms3.topnessMod_genmet(); }
const float &topnessMod_rl_genmet() { return stopcms3.topnessMod_rl_genmet(); }
const float &mt_genmet_lep() { return stopcms3.mt_genmet_lep(); }
const float &mt_genmet_lep_rl() { return stopcms3.mt_genmet_lep_rl(); }
const float &mindphi_genmet_j1_j2() { return stopcms3.mindphi_genmet_j1_j2(); }
const float &mindphi_genmet_j1_j2_rl() { return stopcms3.mindphi_genmet_j1_j2_rl(); }
const float &MT2_ll_genmet() { return stopcms3.MT2_ll_genmet(); }
const bool &filt_cscbeamhalo() { return stopcms3.filt_cscbeamhalo(); }
const bool &filt_cscbeamhalo2015() { return stopcms3.filt_cscbeamhalo2015(); }
const bool &filt_globaltighthalo2016() { return stopcms3.filt_globaltighthalo2016(); }
const bool &filt_globalsupertighthalo2016() { return stopcms3.filt_globalsupertighthalo2016(); }
const bool &filt_ecallaser() { return stopcms3.filt_ecallaser(); }
const bool &filt_ecaltp() { return stopcms3.filt_ecaltp(); }
const bool &filt_ecalbadcalib() { return stopcms3.filt_ecalbadcalib(); }
const bool &filt_eebadsc() { return stopcms3.filt_eebadsc(); }
const bool &filt_goodvtx() { return stopcms3.filt_goodvtx(); }
const bool &filt_badevents() { return stopcms3.filt_badevents(); }
const bool &filt_hbhenoise() { return stopcms3.filt_hbhenoise(); }
const bool &filt_hbheisonoise() { return stopcms3.filt_hbheisonoise(); }
const bool &filt_hcallaser() { return stopcms3.filt_hcallaser(); }
const bool &filt_trkfail() { return stopcms3.filt_trkfail(); }
const bool &filt_trkPOG() { return stopcms3.filt_trkPOG(); }
const bool &filt_trkPOG_logerr_tmc() { return stopcms3.filt_trkPOG_logerr_tmc(); }
const bool &filt_trkPOG_tmc() { return stopcms3.filt_trkPOG_tmc(); }
const bool &filt_trkPOG_tms() { return stopcms3.filt_trkPOG_tms(); }
const int &firstGoodVtxIdx() { return stopcms3.firstGoodVtxIdx(); }
const bool &filt_badChargedCandidateFilter() { return stopcms3.filt_badChargedCandidateFilter(); }
const bool &filt_badMuonFilter() { return stopcms3.filt_badMuonFilter(); }
const bool &filt_met() { return stopcms3.filt_met(); }
const bool &filt_fastsimjets() { return stopcms3.filt_fastsimjets(); }
const bool &filt_fastsimjets_jup() { return stopcms3.filt_fastsimjets_jup(); }
const bool &filt_fastsimjets_jdown() { return stopcms3.filt_fastsimjets_jdown(); }
const bool &filt_jetWithBadMuon() { return stopcms3.filt_jetWithBadMuon(); }
const bool &filt_jetWithBadMuon_jup() { return stopcms3.filt_jetWithBadMuon_jup(); }
const bool &filt_jetWithBadMuon_jdown() { return stopcms3.filt_jetWithBadMuon_jdown(); }
const bool &filt_pfovercalomet() { return stopcms3.filt_pfovercalomet(); }
const bool &filt_badmuons() { return stopcms3.filt_badmuons(); }
const bool &filt_duplicatemuons() { return stopcms3.filt_duplicatemuons(); }
const bool &filt_nobadmuons() { return stopcms3.filt_nobadmuons(); }
...
const float &MT2_had() { return stopcms3.MT2_had(); }
const float &MT2_had_genmet() { return stopcms3.MT2_had_genmet(); }
const float &MT2_had_jup() { return stopcms3.MT2_had_jup(); }
const float &MT2_had_jdown() { return stopcms3.MT2_had_jdown(); }
const float &mht_pt() { return stopcms3.mht_pt(); }
const float &mht_pt_jup() { return stopcms3.mht_pt_jup(); }
const float &mht_pt_jdown() { return stopcms3.mht_pt_jdown(); }
const float &mht_phi() { return stopcms3.mht_phi(); }
const float &mht_phi_jup() { return stopcms3.mht_phi_jup(); }
const float &mht_phi_jdown() { return stopcms3.mht_phi_jdown(); }
const float &pfmet_egclean() { return stopcms3.pfmet_egclean(); }
const float &pfmet_egclean_phi() { return stopcms3.pfmet_egclean_phi(); }
const float &pfmet_muegclean() { return stopcms3.pfmet_muegclean(); }
const float &pfmet_muegclean_phi() { return stopcms3.pfmet_muegclean_phi(); }
const float &pfmet_muegcleanfix() { return stopcms3.pfmet_muegcleanfix(); }
const float &pfmet_muegcleanfix_phi() { return stopcms3.pfmet_muegcleanfix_phi(); }
